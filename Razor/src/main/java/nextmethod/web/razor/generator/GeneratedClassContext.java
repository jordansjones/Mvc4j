...
public class GeneratedClassContext {
    ...
    public static final GeneratedClassContext Default = new GeneratedClassContext(
                                                                                     DefaultExecuteMethodName,
                                                                                     DefaultWriteMethodName,
                                                                                     DefaultWriteLiteralMethodName
    );

    public GeneratedClassContext(final String executeMethodName, final String writeMethodName,
    ...
    public GeneratedClassContext(
        ...
        this(
                executeMethodName, writeMethodName, writeLiteralMethodName, writeToMethodName, writeLiteralToMethodName,
                templateTypeName
            );

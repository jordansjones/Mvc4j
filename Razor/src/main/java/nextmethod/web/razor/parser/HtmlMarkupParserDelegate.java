...
abstract class HtmlMarkupParserDelegate {
    ...
    public void acceptUntil(@Nonnull final HtmlSymbolType type1, @Nonnull final HtmlSymbolType type2,
                            @Nonnull final HtmlSymbolType type3
                           ) {
    ...
    public boolean required(@Nonnull final HtmlSymbolType expected, final boolean errorIfNotFound,
    ...
    public boolean balance(@Nonnull final EnumSet<BalancingModes> mode, @Nonnull final HtmlSymbolType left,
                           @Nonnull final HtmlSymbolType right, @Nonnull final SourceLocation start
                          ) {

...
abstract class JavaCodeParserDelegate {
    ...
    public boolean balance(@Nonnull final BalancingModes mode, @Nonnull JavaSymbolType left,
                           @Nonnull JavaSymbolType right, @Nonnull SourceLocation start
                          ) {
        return balance(EnumSet.of(mode), left, right, start);
    }

    public boolean balance(@Nonnull EnumSet<BalancingModes> mode, @Nonnull JavaSymbolType left,
                           @Nonnull JavaSymbolType right, @Nonnull SourceLocation start
                          ) {
    ...
    public IDisposable pushSpanConfig(@Nullable
                                      Delegates.IAction2<SpanBuilder, Delegates.IAction1<SpanBuilder>> newConfig
                                     ) {
        return delegate.pushSpanConfig(newConfig);
    }

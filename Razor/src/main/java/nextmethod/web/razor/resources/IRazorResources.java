...
public interface IRazorResources
     ...
     *
     * @return translated "The active parser must the same as either the markup or code parser."
     */
     ...
     *
     * @return translated "Block cannot be built because a Type has not been specified in the BlockBuilder"
     */
     ...
     *
     * @return translated "explicit expression"
     */
     ...
     *
     * @return translated "The "CancelBacktrack" method can be called only while in a look-ahead process started with the "BeginLookahead" method."
     */
     ...
     *
     * @return translated "Cannot call CreateCodeWriter, a CodeWriter was not provided to the Create method"
     */
     ...
     *
     * @return translated ""EndBlock" was called without a matching call to "StartBlock"."
     */
     ...
     *
     * @return translated "space or line break"
     */
     ...
     *
     * @return translated "&lt;&lt;newline sequence>>"
     */
     ...
     *
     * @return translated "&lt;&lt;razor comment>>"
     */
     ...
     *
     * @return translated "&lt;&lt;character literal>>"
     */
     ...
     *
     * @return translated "&lt;&lt;integer literal>>"
     */
     ...
     *
     * @return translated "&lt;&lt;real literal>>"
     */
     ...
     *
     * @return translated "&lt;&lt;string literal>>"
     */
     ...
     *
     * @return translated "Cannot use built-in RazorComment handler, language characteristics does not define the CommentStart, CommentStar and CommentBody known symbol types or parser does not override TokenizerBackedParser.OutputSpanBeforeRazorComment"
     */
     ...
     *
     * @return translated "The "@" character must be followed by a ":", "(", or a Java identifier.  If you intended to switch to markup, use an HTML start tag, for example:
     *
     * @if(isLoggedIn) {
     * &lt;p>Hello, @user!&lt;/p>
     * }".
     ...
     *
     * @return translated "End of file was reached before the end of the block comment.  All comments started with "/*" sequence must be terminated with a matching "*<!---->/" sequence."
     */
     ...
     * @param arg0
     *
     * @return translated "The "{0}" block was not terminated.  All "{0}" statements must be terminated with a matching "{1}"."
     */
     ...
     * @param arg0
     *
     * @return translated "An opening "{0}" is missing the corresponding closing "{1}"."
     */
     ...
     * @param arg0
     *
     * @return translated "The {0} block is missing a closing "{1}" character.  Make sure you have a matching "{1}" character for all the "{2}" characters within this block, and that none of the "{1}" characters are being interpreted as markup."
     */
    ...
    public String parseErrorExpectedEndOfBlockBeforeEof(final CharSequence arg0, final CharSequence arg1,
     ...
     *
     * @return translated "Helper blocks cannot be nested within each other."
     */
     ...
     *
     * @return translated "The 'inherits' keyword must be followed by a type name on the same line."
     */
     ...
     *
     * @return translated "Inline markup blocks (@&lt;p>Content&lt;/p>) cannot be nested.  Only one level of inline markup is allowed."
     */
     ...
     *
     * @return translated "Markup in a code block must start with a tag and all start tags must be matched with end tags.  Do not use unclosed tags like "&lt;br>".  Instead use self-closing tags like "&lt;br/>"."
     */
     ...
     * @param arg0
     *
     * @return translated "Expected a "{0}" after the helper name."
     */
     ...
     * @param arg0
     *
     * @return translated "Expected a "{0}" after the helper parameters."
     */
     ...
     * @param arg0
     *
     * @return translated "The "{0}" element was not closed.  All elements must be either self-closing or have a matching end tag."
     */
     ...
     *
     * @return translated "Sections cannot be empty.  The "@section" keyword must be followed by a block of markup surrounded by "'{''}'".  For example:
     *
     * @section Sidebar {
     ...
     *
     * @return translated "Namespace imports and type aliases cannot be placed within code blocks.  They must immediately follow an "@" character in markup.  It is recommended that you put them at the top of the page, as in the following example:
     *
     ...
     *
     * @return translated "The "Imports" keyword must be followed by a namespace or a type alias on the same line."
     */
     ...
     *
     * @return translated "Outer tag is missing a name. The first character of a markup block must be an HTML tag with a valid name."
     */
     ...
     *
     * @return translated "End of file was reached before the end of the block comment.  All comments that start with the "@*" sequence must be terminated with a matching "*@" sequence."
     */
     ...
     * @param arg0
     *
     * @return translated ""{0}" is a reserved word and cannot be used in implicit expressions.  An explicit expression ("@()") must be used."
     */
     ...
     * @param arg0
     *
     * @return translated "Section blocks ("{0}") cannot be nested.  Only one level of section blocks are allowed."
     */
     ...
     * @param arg0
     *
     * @return translated "Expected a "{0}" but found a "{1}".  Block statements must be enclosed in "'{'" and "'}'".  You cannot use single-statement control-flow statements in RZHTML pages. For example, the following is not allowed:
     *
     ...
     *
     * @return translated ""&lt;text>" and "&lt;/text>" tags cannot contain attributes."
     */
     ...
     * @param arg0
     *
     * @return translated "Unexpected "{0}""
     */
     ...
     * @param arg0
     *
     * @return translated "Unexpected {0} after helper keyword.  All helpers must have a name which starts with an "_" or alphabetic character. The remaining characters must be either "_" or alphanumeric."
     */
     ...
     * @param arg0
     *
     * @return translated "Unexpected {0} after section keyword.  Section names must start with an "_" or alphabetic character, and the remaining characters must be either "_" or alphanumeric."
     */
     ...
     * @param arg0
     *
     * @return translated ""{0}" is not valid at the start of a code block.  Only identifiers, keywords, comments, "(" and "'{'" are valid."
     */
     ...
     *
     * @return translated "End-of-file was found after the "@" character.  "@" must be followed by a valid code block.  If you want to output an "@", escape it using the sequence: "@@""
     */
     ...
     * @param arg0
     *
     * @return translated "Unexpected "{0}" keyword after "@" character.  Once inside code, you do not need to prefix constructs like "{0}" with "@"."
     */
     ...
     *
     * @return translated "Unexpected "'{'" after "@" character. Once inside the body of a code block (@if '{''}', @'{''}', etc.) you do not need to use "@'{'" to switch to code."
     */
     ...
     *
     * @return translated "A space or line break was encountered after the "@" character.  Only valid identifiers, keywords, comments, "(" and "'{'" are valid at the start of a code block and they must occur immediately following "@" with no space in between."
     */
     ...
     * @param arg0
     *
     * @return translated "Encountered end tag "{0}" with no matching start tag.  Are your start/end tags properly balanced?"
     */
     ...
     * @param arg0
     *
     * @return translated "End of file or an unexpected character was reached before the "{0}" tag could be parsed.  Elements inside markup blocks must be complete. They must either be self-closing ("&lt;br />") or have matching end tags ("&lt;p>Hello&lt;/p>").  If you intended to display a "&lt;" character, use the "&amp;lt;" HTML entity."
     */
     ...
     * @param arg0
     *
     * @return translated "Unknown option: "{0}"."
     */
     ...
     *
     * @return translated "Unterminated string literal.  Strings that start with a quotation mark (") must be terminated before the end of the line.  However, strings that start with @ and a quotation mark (@") can span multiple lines."
     */
     ...
     *
     * @return translated "Helper parameter list is missing a closing ")"."
     */
     ...
     *
     * @return translated "Parser was started with a null Context property.  The Context property must be set BEFORE calling any methods on the parser."
     */
     ...
     *
     * @return translated "Cannot complete the tree, StartBlock must be called at least once."
     */
     ...
     *
     * @return translated "Cannot complete the tree, there are still open blocks."
     */
     ...
     *
     * @return translated "Cannot finish span, there is no current block. Call StartBlock at least once before finishing a span"
     */
     ...
     *
     * @return translated "Cannot complete action, the parser has finished. Only CompleteParse can be called to extract the final parser results after the parser has finished"
     */
     ...
     *
     * @return translated "Missing value for session state directive."
     */
     ...
     *
     * @return translated "The parser provided to the ParserContext was not a Markup Parser."
     */
     ...
     *
     * @return translated "@section Header { ... }"
     */
     ...
     * @param arg0
     *
     * @return translated "The {0} property of the {1} structure cannot be null."
     */
     ...
     *
     * @return translated "Cannot resume this symbol. Only the symbol immediately preceding the current one can be resumed."
     */
     ...
     * @param arg0
     *
     * @return translated "In order to put a symbol back, it must have been the symbol which ended at the current position. The specified symbol ends at {0,number}, but the current position is {1,number}"
     */
     ...
     * @param arg0
     *
     * @return translated "[BG][{0}] Shutdown"
     */
     ...
     * @param arg0
     *
     * @return translated "[BG][{0}] Startup"
     */
     ...
     * @param arg0
     *
     * @return translated "[BG][{0}] {1} changes arrived"
     */
     ...
     * @param arg0
     *
     * @return translated "[BG][{0}] Discarded {1} changes"
     */
     ...
     * @param arg0
     *
     * @return translated "[BG][{0}] Collecting {1} discarded changes"
     */
     ...
     * @param arg0
     *
     * @return translated "[P][{0}] {3} Change in {2} milliseconds: {1}"
     */
    ...
    public String traceEditorProcessedChange(final CharSequence arg0, final CharSequence arg1, final CharSequence arg2,
                                             final CharSequence arg3
                                            );
     ...
     * @param arg0
     *
     * @return translated "[P][{0}] Received Change: {1}"
     */
     ...
     * @param arg0
     *
     * @return translated "[BG][{0}] no changes arrived?"
     */
     ...
     * @param arg0
     *
     * @return translated "[BG][{0}] Parse Complete in {1} milliseconds"
     */
     ...
     * @param arg0
     *
     * @return translated "[M][{0}] Queuing Parse for: {1}"
     */
     ...
     * @param arg0
     *
     * @return translated "[Razor] Editor Tracing {0}"
     */
     ...
     * @param arg0
     *
     * @return translated "[BG][{0}] Trees Compared in {1} milliseconds. Different = {2}"
     */

...
public class TextChange {
	...
	public TextChange(final int oldPosition, final int oldLength, @Nonnull final ITextBuffer oldBuffer, final int newPosition, final int newLength, @Nonnull final ITextBuffer newBuffer) {
		...
		checkArgument(oldLength < 0, CommonResources().getString("argument.must.be.greaterThanOrEqualTo"), "0");
		checkArgument(newLength < 0, CommonResources().getString("argument.must.be.greaterThanOrEqualTo"), "0");

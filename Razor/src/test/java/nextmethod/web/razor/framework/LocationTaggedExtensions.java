...
public final class LocationTaggedExtensions {
    ...
    public static LocationTagged<String> locationTagged(final String value, final int offset, final int line,
                                                        final int col
                                                       ) {
        return new LocationTagged<>(value, offset, line, col);
    }

    public static LocationTagged<SpanCodeGenerator> locationTagged(final SpanCodeGenerator generator, final int offset,

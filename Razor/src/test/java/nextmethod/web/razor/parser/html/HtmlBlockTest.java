...
public class HtmlBlockTest extends JavaHtmlMarkupParserTestBase {
    ...
    public void parseBlockStopsAtMatchingCloseTagToStartTag() {
        singleSpanBlockTest(
                               "<a><b></b></a><c></c>", "<a><b></b></a>", BlockType.Markup, SpanKind.Markup,
                               AcceptedCharacters.None
                           );
    }
    ...
    public void parseBlockParsesUntilMatchingEndTagIfFirstNonWhitespaceCharacterIsStartTag() {
        singleSpanBlockTest(
                               "<baz><boz><biz></biz></boz></baz>", BlockType.Markup, SpanKind.Markup,
                               AcceptedCharacters.None
                           );
    }
    ...
    public void parseBlockTerminatesAtEOF() {
        singleSpanBlockTest(
                               "<foo>", "<foo>", BlockType.Markup, SpanKind.Markup,
                               new RazorError(
    ...
    public void parseBlockSupportsCommentWithinBlock() {
        singleSpanBlockTest(
                               "<foo>bar<!-- zoop -->baz</foo>", BlockType.Markup, SpanKind.Markup,
                               AcceptedCharacters.None
                           );
    }
    ...
    public void parseBlockTerminatesCommentAtFirstOccurrenceOfEndSequence() {
        singleSpanBlockTest(
                               "<foo><!--<foo></bar-->--></foo>", BlockType.Markup, SpanKind.Markup,
                               AcceptedCharacters.None
                           );
    }
    ...
    public void parseBlockParsesSGMLDeclarationAsEmptyTag() {
        singleSpanBlockTest(
                               "<foo><!DOCTYPE foo bar baz></foo>", BlockType.Markup, SpanKind.Markup,
                               AcceptedCharacters.None
                           );
    }
    ...
    public void parseBlockParsesXMLProcessingInstructionAsEmptyTag() {
        singleSpanBlockTest(
                               "<foo><?xml foo bar baz?></foo>", BlockType.Markup, SpanKind.Markup,
                               AcceptedCharacters.None
                           );
    }
    ...
    public void parseBlockSupportsScriptTagsWithLessThanSignsInThem() {
        singleSpanBlockTest(
                               "<script>if(foo<bar) { alert(\"baz\");)</script>", BlockType.Markup, SpanKind.Markup,
                               AcceptedCharacters.None
                           );
    }
    ...
    public void parseBlockDoesNotConsiderPsuedoTagWithinMarkupBlock() {
        parseBlockTest(
                          ...
                          new MarkupBlock(
                                             factory().markup("<foo><text><bar></bar></foo>")
                                                      .accepts(AcceptedCharacters.None)
                          )
                      );
    }

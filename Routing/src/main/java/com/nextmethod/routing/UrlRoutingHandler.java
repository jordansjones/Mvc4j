...
public abstract class UrlRoutingHandler implements IHttpHandler {
	...
	@Override
	public void processRequest(final HttpContext httpContext) throws HttpException {
	...
	protected abstract void verifyAndProcessRequest(IHttpHandler httpHandler, HttpContext httpContext);

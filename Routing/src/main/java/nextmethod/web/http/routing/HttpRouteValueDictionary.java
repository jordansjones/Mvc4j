 ...
 * 
 */
public class HttpRouteValueDictionary implements IDictionary<String, Object> {
...
//		this(null);
	...
	public HttpRouteValueDictionary(@Nullable final Builder values) {
		if (values != null) {
			this.routeValues.add(values.build().routeValues);
		}
	}

	public HttpRouteValueDictionary(@Nullable final Map<String, Object> values) {
		if (values != null && !values.isEmpty())
			this.routeValues.add(values);
	}

	@Override
	public HttpRouteValueDictionary add(final KeyValuePair<String, Object> item) {
		this.routeValues.add(item);
		return this;
	}

	@Override
	public HttpRouteValueDictionary add(final String s, final Object o) {
		this.routeValues.add(s, o);
		return this;
	}

	@Override
	public HttpRouteValueDictionary add(final IDictionary<? extends String, ? extends Object> items) {
		this.routeValues.add(items);
		return this;
	}

	@Override
	public HttpRouteValueDictionary add(final Map<String, Object> items) {
		this.routeValues.add(items);
		return this;
	}

	@Override
	public HttpRouteValueDictionary clear() {
	...
	@Override
	public HttpRouteValueDictionary copyTo(final KeyValuePair<String, Object>[] array, final int arrayIndex) {
		this.routeValues.copyTo(array, arrayIndex);
		return this;
	}

	@Override
	public HttpRouteValueDictionary filterEntries(final Predicate<KeyValuePair<String, Object>> filter) {
		final HttpRouteValueDictionary dictionary = new HttpRouteValueDictionary();
	...
	@Override
	public HttpRouteValueDictionary put(final String s, final Object o) {
	...
	@Override
	public HttpRouteValueDictionary set(final String s, final Object o) {
	...
	public static final class Builder {
		...
		private final HttpRouteValueDictionary dictionary;

		public Builder() {
			this.dictionary = new HttpRouteValueDictionary();
		}
		...
		public HttpRouteValueDictionary build() {

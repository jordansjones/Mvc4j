...
//	}
	...
	public VirtualPathData getVirtualPath(final RequestContext requestContext, final HttpRouteValueDictionary httpRouteValueDictionary) {
		return getVirtualPath(requestContext, null, httpRouteValueDictionary);
	}

	public VirtualPathData getVirtualPath(final RequestContext requestContext, @Nullable final String name, final HttpRouteValueDictionary values) {
